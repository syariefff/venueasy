...
import Bgm from '@/assets/images/surabaya.svg';
        ...
        <RecommendedSection venues = {venues} count={4}/>
              ...
              <div>
                ...
                <div className="flex items-center justify-center space-x-8 gap-12 mt-10">
                  ...
                  <div>
                    <Image src={Outdoor} alt="BallRoom Icon" width={70} height={70} className="mx-auto mr-3 mt-2" />
                    <p className="mt-4 text-lg font-semibold">Outdoor</p>
                  </div>
                  <div>
                    <Image src={Ballroom} alt="BallRoom Icon" width={70} height={70} className="mx-auto mt-2" />
