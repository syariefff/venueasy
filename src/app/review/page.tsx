          ...
          <div className="flex-1 ml-10 mr-10">
            ...
            <div className="text-black flex flex-col items-center">
              ...
              <ul className="text-black">
                <li className="mb-1">Weekand: 2:00PM - 12:00AM</li>
          ...
          <div className="text-black">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-gray-300 p-4 rounded-lg shadow text-black">
                ...
                <p>Hotel bintang 4 dengan lokasinya dekat dengan aktivitas wisata dalam jakarta seperti monas, masjid istiqlal, perpustaan nasional dan dekat dengan pusat kuliner jalan sabang serta pusat perbelanjaan sarinah. Mungkin salah satu yang perlu di improve adalah jenis sarapannya yang pilihannya kurang banyak</p>
              </div>
              <div className="bg-gray-300 p-4 rounded-lg shadow text-black">
                <div className="flex items-center mb-2">
                  <Image alt="User profile picture" className="w-10 h-10 rounded-full mr-2" height="40" src={Pp} width="40"/>
                  <div>
                    <div className="font-semibold">Tzong Rachmat</div>
                    <div className="text-gray-600 text-sm">3 weeks ago</div>
                  </div>
                  <div className="ml-auto flex items-center">
                    <Icon icon="noto:star" style={{ fontSize: "16px", color: "#FFC107" }} />
                    <span className="font-semibold ml-1">4.6</span>
                  </div>
                </div>
                <p>KAMAR nya Nyamann bgtt bersihhh enakk laahh pokoknya disinii ada harga ada rupa laa yyaaa BREAKFAST superrr enak! Cakep bgt tempatnya! Suka bgtt sarapan disitu bisa breakfast with a view..... seru bgtt di bangku luar itu</p>
              </div>
              <div className="bg-gray-300 p-4 rounded-lg shadow text-black">
                <div className="flex items-center mb-2">
                  <Image alt="User profile picture" className="w-10 h-10 rounded-full mr-2" height="40" src={Pp} width="40"/>
                  <div>
                    <div className="font-semibold">Raul Skuuy</div>
                    <div className="text-gray-600 text-sm">3 weeks ago</div>
                  </div>
                  <div className="ml-auto flex items-center">
                  <Icon icon="noto:star" style={{ fontSize: "16px", color: "#FFC107" }} />
                ...
                <p>View kamar good menghadap jalan sabang, menikmati padatnya lalu lintas jalan sabang, pelayanan mantap, security bang Shahrul ramah dan good job.... AKMANI Pokoke OK Punya.... from room 716</p>
              </div>
            </div>
          </div>
